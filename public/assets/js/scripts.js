/*
:: Project Name : Bistec
:: Project URI: http://bionthemes.net/bistec
:: Description: Bistec - Admin Dashboard HTML5 Template
:: Project Date: 05-05-2017
:: Version: 1.0
:: Author: BionThemes
:: Author Website : http://bionthemes.net/
*/
...
(function($) {
  ...
  */
  ...
  /*
   * Trying to work masonry
   */

  if ($('.an-masonry-layout').length > 0) {
    $('.an-masonry-layout').masonry({
